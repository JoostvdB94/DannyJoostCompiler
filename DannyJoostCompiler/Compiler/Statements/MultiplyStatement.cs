...
namespace DannyJoostCompiler
{
    public class MultiplyStatement : Statement
    {
        public override DoubleLinkedList Compile(ref LinkedListNode<Token> currentToken)
        {
            ...
            compiledStatement.AddLast(NodeFactory.Create("FunctionCall", "Multiply", new List<Token>() { Token.create(0, 0, TokenEnumeration.Unknown, leftHandValue, 0), Token.create(0, 0, TokenEnumeration.Unknown, rightHandValue, 0) }));
